                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class=" p-2 rounded col-md-12 mt-1 mx-auto">
                            <p class="mt-1 text-center" style="font-size: 20px; font-weight: 500; color: dimgray"><span>
                                    Email us</span>
                            </p>
                            ...
                            <form action="{{ url('/send-email') }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" name="email" value="None" readonly>
                                </div>
                                <div class="form-group">
                                ...
                                <button type="submit" class="btn btn-sm btn-success mt-3"><span
