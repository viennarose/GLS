            ...
            <div class="col-md-6 mt-3">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-5">
                        ...
                        <div class="modal fade" id="profile_id{{ Auth::user()->id }}" tabindex="-1"
                            role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" style="color:dimgray; font-size: 16px;">Change Password</h5>
                                    ...
                                    {{-- <form action="{{ route('admin.update_profile', Auth::user()->id) }}"
                                        ...
                                        style="font-size: 20px; height: 23px;"></span></span></label>
                                        ...
                                        <div class="form-group d-flex justify-content-center">
                                        <label for="password"><span class="input-group-text text-light bg-secondary"
                    ...
                    <div class="input-group mb-3">
                        <label for="" style="color:dimgray;"><span
                                class="fas fa-user input-group-text bg-secondary text-white"></span></label>
                        <input type="text" name="name" value="{{ Auth::user()->name }}" class="form-control"
                            required>
                    </div>
                    <div class="input-group mb-3">
                        <label for="" style="color:dimgray;"><span
                                class="fas fa-envelope input-group-text bg-secondary text-white"></span></label>
